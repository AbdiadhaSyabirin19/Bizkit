                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex justify-between items-center py-2 border-b border-gray-50">
                    ...
                    <span className="font-semibold text-gray-800">
                      {formatRp(data?.total_transaksi > 0 ? (data?.total_omzet / data?.total_transaksi) : 0)}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-50">
                    <span className="text-sm text-gray-600">📦 Rata-rata Item/Transaksi</span>
                    <span className="font-semibold text-gray-800">
                      {data?.total_transaksi > 0 ? (data?.total_qty / data?.total_transaksi).toFixed(1) : 0}
                    </span>
                  </div>
