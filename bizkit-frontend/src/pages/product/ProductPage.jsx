    ...
    },
    {
      ...
      render: (row) => (
        <div className="flex gap-2">
          <button onClick={() => navigate(`/products/${getID(row)}`)} className="px-3 py-1 bg-gray-500 hover:bg-gray-600 text-white rounded-lg text-xs transition">Detail</button>
          <button onClick={() => navigate(`/products/${getID(row)}/edit`)} className="px-3 py-1 bg-blue-500 hover:bg-blue-600 text-white rounded-lg text-xs transition">Edit</button>
